      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {referrerStats.map((ref, index) => (
            <div key={ref.source}>
              <Card 
                className={`bg-[var(--brand-card)] border ${getSourceBgColor(ref.source)} cursor-pointer hover:bg-[var(--brand-card)] transition-colors`}
              ...
              {/* Breakdown Table */}
              {expandedSource === ref.source && (
                <Card className="bg-[var(--brand-card)] border-[var(--brand-border)] mt-1 ml-6">
                  <CardContent className="py-4">
                    {loadingBreakdown ? (
                        ...
                        <Table>
                          ...
                          <TableBody>
                            {breakdown.slice(0, 10).map((click, idx) => (
                              <TableRow key={idx} className="border-[var(--brand-border)]">
