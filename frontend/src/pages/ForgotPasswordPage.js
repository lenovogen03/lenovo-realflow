...
export default function ForgotPasswordPage() {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-[var(--brand-card)] flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-[var(--brand-card)] border-[var(--brand-border)]">
