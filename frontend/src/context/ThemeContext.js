...
export const THEMES = {
  dark: {
    ...
    colors: {
      ...
      card_color: "#0A0A14",
      card_elevated_color: "#101020",
      border_color: "rgba(79, 127, 255, 0.2)",
      text_color: "#FAFAFA",
      muted_color: "#A0A0A0",
    },
  },
...
function applyThemeColors(colors) {
  ...
  const map = {
    ...
    card_elevated_color: ["--brand-card-elevated"],
